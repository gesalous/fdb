...
/// @file   ParallaxCommon.h
/// @author Giorgos Saloustros
/// @author Michail Toutoudakis
/// @date   June 2024

#ifndef fdb5_parallax_ParallaxEngine_H
#define fdb5_parallax_ParallaxEngine_H
...
class ParallaxEngine : public fdb5::Engine {

public: // methods

    static const char* typeName() { return "parallax"; }
